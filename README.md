...
本项目包含75+工具和资源 ，用于帮助红队活动。

一些工具是专门为红队设计、也有部分通用工具，二者皆可适应红队日常工作环境。

> **Warning** 
> 
> *本项目所提到的工具或资源仅供参考和教育目的，不得用于任何非法活动。*
...
<details open>
    ...
    <ul>
        <ul>
            ...
            <li><b><a href="#dnsrecon">dnsrecon</a></b><i> DNS记录枚举</i></li>
            <li><b><a href="#shodanio">Shodan.io</a></b><i> Shodan</i></li>
            <li><b><a href="#aort">AORT (All in One Recon Tool)</a></b><i> 子域名枚举</i></li>
            <li><b><a href="#spoofcheck">spoofcheck</a></b><i> SPF/DMARC 记录检查</i></li>
            <li><b><a href="#awsbucketdump">AWSBucketDump</a></b><i> S3 bucket 枚举</i></li>
            <li><b><a href="#githarvester">GitHarvester</a></b><i> GitHub 凭据搜索</i></li>
            <li><b><a href="#trufflehog">truffleHog</a></b><i> GitHub 凭据扫描</i></li>
            <li><b><a href="#dismap">Dismap</a></b><i> 资产的发现/识别</i></li>
            <li><b><a href="#enum4linux">enum4linux</a></b><i> Windows/samba 枚举</i></li>
        </ul>
    </ul>
</details>
...
<details open>
    ...
    <ul>
        <ul>
            <li><b><a href="#bash-bunny">Bash Bunny</a></b><i> USB攻击工具</i></li>
            <li><b><a href="#evilgophish">EvilGoPhish</a></b><i> 钓鱼框架</i></li>
            <li><b><a href="#social-engineer-toolkit-set">The Social-Engineer Toolkit</a></b><i> 钓鱼框架</i></li>
            <li><b><a href="#hydra">Hydra</a></b><i> 密码暴力破解工具</i></li>
            <li><b><a href="#squarephish">SquarePhish</a></b><i> OAuth/QRcode钓鱼框架</i></li>
            <li><b><a href="#king-phisher">King Phisher</a></b><i> 钓鱼框架</i></li>
        </ul>
    </ul>
</details>
